...
class StatisticsOverview extends StatelessWidget {
  const StatisticsOverview({super.key, required this.dashboardData});
            ...
            children: [
              Expanded(
                child: StatsCard(
                  ...
                  value: _formatNumber(dashboardData.activeStudents, context),
            ...
            children: [
              ...
              Expanded(
                child: StatsCard(
                  ...
                  value: _formatNumber(dashboardData.totalAdmins, context),
                  color: Colors.cyan,
                  isPositive: true,
                ),
              ),
            ...
            children: [
              Expanded(
                child: StatsCard(
                  ...
                  value: _formatNumber(dashboardData.totalCategories, context),
                  color: Colors.purple,
                  isPositive: true,
                ),
              ),
              Expanded(
                child: StatsCard(
                  ...
                  value: _formatNumber(dashboardData.totalInstructors, context),
