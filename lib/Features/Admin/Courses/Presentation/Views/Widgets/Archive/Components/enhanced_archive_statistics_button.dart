...
/// Enhanced archive course statistics button with modern design and animations
class EnhancedArchiveStatisticsButton extends StatelessWidget {
  const EnhancedArchiveStatisticsButton({
    super.key,
  ...
  Widget build(BuildContext context) {
    return EnhancedMenuButton(
      ...
      tooltip: S.of(context).archiveStatisticsTooltip,
      semanticLabel: S.of(context).archiveStatisticsSemanticLabel(course.title),
      shortcutKey: 'Ctrl+S',
      onTap: () async {
        await context.push(
          StatisticsView.id,
